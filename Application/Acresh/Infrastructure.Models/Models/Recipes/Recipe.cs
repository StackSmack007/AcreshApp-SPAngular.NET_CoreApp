...
namespace Infrastructure.Models
{
    public class Recipe : BaseEntity<string>,IReportable
    {
        public Recipe()
        {
            ...
            RecipeFavorisers = new HashSet<UserFavouriteRecepy>();
        ...
        [NotMapped]
        public virtual bool IsVegan => Ingredients.Any(x => !x.IsVegan);
        [NotMapped]
        public virtual RecipeRating AverageRating => (RecipeRating)(Votes.Any() ? 0 : Math.Round(((double)Votes.Sum(x => (int)x.Score)) / Votes.Count()));
        public virtual ICollection<UserFavouriteRecepy> RecipeFavorisers { get; set; }
